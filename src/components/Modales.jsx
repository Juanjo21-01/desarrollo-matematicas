...
const Modales = () => {
  ...
  return (
    <article className="row mt-3">
      <section className="col-12 d-flex justify-content-evenly mb-3 flex-wrap gap-2">
        ...
        <Modal nameModal={nameModal}>
          ...
          <img
            src="/desarrollo-matematicas/img/tablas.jpg"
        ...
        <Modal nameModal={nameModal2}>
          ...
          <img
            src="/desarrollo-matematicas/img/sumas.webp"
        ...
        <Modal nameModal={nameModal3}>
          ...
          <img
            src="/desarrollo-matematicas/img/multiplicacion.png"
